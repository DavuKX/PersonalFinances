...
class WalletRepositoryAdapterTest {
    ...
    void save_returnsMappedDomainWallet() {
        ...
        Wallet wallet = new Wallet(walletId, userId, "Main Wallet", "USD", BigDecimal.valueOf(500), entity.getCreatedAt(), entity.getUpdatedAt());
    ...
    void delete_callsDeleteById() {
        Wallet wallet = new Wallet(walletId, userId, "Main Wallet", "USD", BigDecimal.ZERO, OffsetDateTime.now(), OffsetDateTime.now());
